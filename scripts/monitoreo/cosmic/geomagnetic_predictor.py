...
class GeomagneticPredictor:
    ...
    def __init__(self):
        ...
        self.G_SCALE = {
            "G1": {
                "min": 50,
                "max": 99,
                "effects": "Pequeñas fluctuaciones red eléctrica",
            },
            "G2": {
                "min": 100,
                "max": 199,
                "effects": "Problemas sistemas de navegación",
            },
            "G3": {"min": 200, "max": 349, "effects": "Interrupciones radio HF"},
            "G4": {
                "min": 350,
                "max": 499,
                "effects": "Apagones generalizados, daños transformadores",
            },
            "G5": {
                "min": 500,
                "max": float("inf"),
                "effects": "Colapso infraestructuras eléctricas",
            },
        }
    ...
    def _estimate_kp_index(self):
        ...
        solar_cycle = 0.3 * np.sin(
            datetime.now().year * 2 * np.pi / 11
        )  # Ciclo 11 años
